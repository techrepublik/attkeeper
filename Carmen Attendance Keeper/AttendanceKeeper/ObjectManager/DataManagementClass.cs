...
namespace ObjectManager
{
    class DataManagementClass
    {
        ...
        {
            Miscellaneou misc = GetMiscellaneous();
        ...
        public static List<DTR> LoadEnrolleeAttendanceDTR(ObjectManager.Enrollee eEnrollee, List<Machine> lAttLog, out List<MacDumpLog> lDumpLogs, string sUserName)
        {
        ...
        public static List<DTR> LoadEnrolleeAttendanceDTR(Enrollee eEnrollee, List<Machine> lAttLog,
        ...
        public static List<DTR> LoadDTRViaDTR(Enrollee enrollee, int iMonth, int iYear, List<DTR> lDTRs, Miscellaneou oMisc)
        {
                        ...
                        if (detail.SettingDetailDay.Trim() == sDay.Trim())
                        {
                            ...
                            if (dtrTemp.TimeInAM != null)
                            {
                                ...
                                if (DateTime.TryParse(dtrTemp.TimeInAM, out tempTimeInAM))
                                {
                                    ...
                                    if (Misc.MiscActive == true)
                                    {
                                        ...
                                        if (DateTimeClass.IsCompareTime((DateTime)dtTimeInAM, tempSetTime, 0, Convert.ToDouble(Misc.MiscGraceInAM), out dOver))
                                        {
                                            DateTime tempTime = dOver > 0 ? dtTimeInAM.Value.AddMinutes(-Convert.ToDouble(Misc.MiscGraceInAM)) : tempSetTime;
                                            //DateTime tempTime =
                                    ...
                                    else
                                    {
                                        string shortTimeString = detail.SettingDetailINAM.Value.ToShortTimeString();
                                        DateTime tempSetTime = Convert.ToDateTime(shortTimeString);
                                        dtTimeInAM = DateTimeClass.IsCompareTime(dtTimeInAM.Value, tempSetTime, 0, Convert.ToDouble(Misc.MiscGraceInAM), out dOver) ? dtTimeInAM : tempSetTime;
                                    }
                                }
                                else
                                {
                            ...
                            if (dtrTemp.TimeOutAM != null)
                            {
                                ...
                                if (DateTime.TryParse(dtrTemp.TimeOutAM, out tempTimeOutAM))
                                {
                                    ...
                                    dtTimeOutAM = DateTimeClass.IsCompareTime((DateTime)dtTimeOutAM, dtShort, 1, 0, out dOver)
                                                      ? dtTimeOutAM
                                                      : dtShort;
                                }
                            }
                            ...
                            if (dtrTemp.TimeInPM != null)
                            {
                                ...
                                if (DateTime.TryParse(dtrTemp.TimeInPM, out tempTimeInPM))
                                {
                                    ...
                                    if (Misc.MiscActive == true)
                                    {
                                        ...
                                        DateTime tempSetTime = Convert.ToDateTime(shortTimeString);
                                        //dtTimeInAM = DateTimeClass.IsCompareTime(dtTimeInAM, Convert.ToDateTime(detail.SettingDetailINAM), 0) ? dtTimeInAM : Convert.ToDateTime(detail.SettingDetailINAM);
                                        if (DateTimeClass.IsCompareTime((DateTime)dtTimeInPM, tempSetTime, 0, Convert.ToDouble(Misc.MiscGraceInPM), out dOver))
                                        {

                                            //this is the culprit --------->>>>
                                            //DateTime tempTime =
                                            //    dtTimeInPM.Value.AddMinutes(-Convert.ToDouble(Misc.MiscGraceInPM));
                                            DateTime tempTime = dOver > 0 ? dtTimeInPM.Value.AddMinutes(-Convert.ToDouble(Misc.MiscGraceInPM)) : tempSetTime;
                                            //if (DateTimeClass.IsCompareTime(tempTime, tempSetTime, 0))
                                            //{
                                    ...
                                    else
                                    {
                                        string shortTimeString = detail.SettingDetailINPM.Value.ToShortTimeString();
                                        DateTime tempSetTime = Convert.ToDateTime(shortTimeString);
                                        dtTimeInPM = DateTimeClass.IsCompareTime(dtTimeInPM.Value, tempSetTime, 0, Convert.ToDouble(Misc.MiscGraceInPM), out dOver)
                                                         ? dtTimeInPM
                                                         : tempSetTime;
                                    }
                                }
                            ...
                            if (dtrTemp.TimeOutPM != null)
                            {
                                ...
                                if (DateTime.TryParse(dtrTemp.TimeOutPM, out tempTimeOutPM))
                                {
                                    ...
                                    DateTime dtShort = Convert.ToDateTime(shortTimeString);
                                    dtTimeOutPM = DateTimeClass.IsCompareTime((DateTime)dtTimeOutPM, dtShort, 1, 0, out dOver)
                                                      ? dtTimeOutPM
                                                      : dtShort;
                                }
                            }
                            ...
                            if (dtrTemp.TimeInOT != null)
                            {
                                ...
                                if (DateTime.TryParse(dtrTemp.TimeInOT, out tempTimeInOT))
                                {
                                    ...
                                    if (Misc.MiscActive == true)
                                    {
                                        ...
                                        DateTime tempSetTime = Convert.ToDateTime(shortTimeString);
                                        //dtTimeInAM = DateTimeClass.IsCompareTime(dtTimeInAM, Convert.ToDateTime(detail.SettingDetailINAM), 0) ? dtTimeInAM : Convert.ToDateTime(detail.SettingDetailINAM);
                                        if (DateTimeClass.IsCompareTime((DateTime)dtTimeInOT, tempSetTime, 0, Convert.ToDouble(Misc.MiscGraceInOT), out dOver))
                                        {
                                            //DateTime tempTime =
                                            //    dtTimeInOT.Value.AddMinutes(-Convert.ToDouble(Misc.MiscGraceInOT));
                                            DateTime tempTime = dOver > 0 ? dtTimeInOT.Value.AddMinutes(-Convert.ToDouble(Misc.MiscGraceInOT)) : dtTimeInOT.Value;
                                            //if (DateTimeClass.IsCompareTime(tempTime, tempSetTime, 0))
                                            //{
                                    ...
                                    else
                                    {
                                        string shortTimeString = detail.SettingDetailINOT.Value.ToShortTimeString();
                                        DateTime tempSetTime = Convert.ToDateTime(shortTimeString);
                                        dtTimeInOT = DateTimeClass.IsCompareTime(dtTimeInOT.Value, tempSetTime, 0, Convert.ToDouble(Misc.MiscGraceInOT), out dOver)
                                                         ? dtTimeInPM
                                                         : tempSetTime;
                                    }
                                }
                            ...
                            if (dtrTemp.TimeOutOT != null)
                            {
                                ...
                                if (DateTime.TryParse(dtrTemp.TimeOutOT, out tempTimeOutOT))
                                {
                                    ...
                                    string shortTimeString = detail.SettingDetailOUTPM.Value.ToShortTimeString();
                                    DateTime dtShort = Convert.ToDateTime(shortTimeString);
                                    dtTimeOutOT = DateTimeClass.IsCompareTime((DateTime)dtTimeOutOT, dtShort, 1, 0, out dOver)
                                                      ? dtTimeOutOT
                                                      : dtShort;
                                }
                            }
        ...
        public static List<JDTR> LoadDTRViaDTRBatch(Enrollee enrollee, int iMonth, int iStart, int iEnd, int iYear, List<DTR> lDTRs, Miscellaneou oMisc, string sName, string sDuration)
        {
            var lDT = new List<JDTR>();
            var lSetDeatils = new List<SettingDetail>();
            var dLeave = LoadLeaveDictionary(enrollee.EnrolleeId, iMonth, iYear);
            var Misc = oMisc;
            lSetDeatils = ActionClass.FillSettingDetails(Convert.ToInt16(enrollee.SettingId));
                            ...
                            if (detail.SettingDetailDay.Trim() == sDay.Trim())
                            {
                                ...
                                if (dtrTemp.TimeOutAM != null)
                                {
                                    ...
                                    if (DateTime.TryParse(dtrTemp.TimeOutAM, out tempTimeOutAM))
                                    {
                                        ...
                                        string shortTimeString = detail.SettingDetailOUTAM.Value.ToShortTimeString();
                                        DateTime dtShort = Convert.ToDateTime(shortTimeString);
                                        dtTimeOutAM = DateTimeClass.IsCompareTime((DateTime)dtTimeOutAM, dtShort, 1, 0,
                                                                                  out dOver)
                                                          ? dtTimeOutAM
                                                          : dtShort;
                                    }
                                ...
                                if (dtrTemp.TimeOutPM != null)
                                {
                                    ...
                                    if (DateTime.TryParse(dtrTemp.TimeOutPM, out tempTimeOutPM))
                                    {
                                        ...
                                        string shortTimeString = detail.SettingDetailOUTPM.Value.ToShortTimeString();
                                        DateTime dtShort = Convert.ToDateTime(shortTimeString);
                                        dtTimeOutPM = DateTimeClass.IsCompareTime((DateTime)dtTimeOutPM, dtShort, 1, 0,
                                                                                  out dOver)
                                                          ? dtTimeOutPM
                                                          : dtShort;
                                    }
                                    ...
                                    if (DateTime.TryParse(dtrTemp.TimeInOT, out tempTimeInOT))
                                    {
                                        ...
                                        if (Misc.MiscActive == true)
                                        {
                                            ...
                                            if (DateTimeClass.IsCompareTime((DateTime)dtTimeInOT, tempSetTime, 0,
                                                                            Convert.ToDouble(Misc.MiscGraceInOT),
                                                                            out dOver))
                                            {
                                                //DateTime tempTime =
                                                //    dtTimeInOT.Value.AddMinutes(-Convert.ToDouble(Misc.MiscGraceInOT));
                                ...
                                if (dtrTemp.TimeOutOT != null)
                                {
                                    ...
                                    if (DateTime.TryParse(dtrTemp.TimeOutOT, out tempTimeOutOT))
                                    {
                                        ...
                                        string shortTimeString = detail.SettingDetailOUTPM.Value.ToShortTimeString();
                                        DateTime dtShort = Convert.ToDateTime(shortTimeString);
                                        dtTimeOutOT = DateTimeClass.IsCompareTime((DateTime)dtTimeOutOT, dtShort, 1, 0,
                                                                                  out dOver)
                                                          ? dtTimeOutOT
                                                          : dtShort;
                                    }
                                    ...
                                    if (DateTime.TryParse(dtrTemp.TimeInAM, out tempTimeInAM))
                                    {
                                        ...
                                        if (Misc.MiscActive == true)
                                        {
                                            ...
                                            if (DateTimeClass.IsCompareTime((DateTime)dtTimeInAM, tempSetTime, 0, Convert.ToDouble(Misc.MiscGraceInAM), out dOver))
                                            {
                                                //DateTime tempTime =
                                                //    dtTimeInAM.Value.AddMinutes(-Convert.ToDouble(Misc.MiscGraceInAM));
                                                DateTime tempTime = dtTimeInAM.Value;
                                                //if (DateTimeClass.IsCompareTime(tempTime, tempSetTime, 0))
                                                //{
                                                dtTimeInAM = (Misc.MiscGraceInAM <= tempTime.Minute)
                                                                 ? tempTime
                                        ...
                                        else
                                        {
                                            string shortTimeString = detail.SettingDetailINAM.Value.ToShortTimeString();
                                            DateTime tempSetTime = Convert.ToDateTime(shortTimeString);
                                            dtTimeInAM = DateTimeClass.IsCompareTime(dtTimeInAM.Value, tempSetTime, 0, Convert.ToDouble(Misc.MiscGraceInAM), out dOver)
                                                             ? dtTimeInAM
                                                             : tempSetTime;
                                        }
                                    }
                                    ...
                                    if (DateTime.TryParse(dtrTemp.TimeInPM, out tempTimeInPM))
                                    {
                                        ...
                                        if (Misc.MiscActive == true)
                                        {
                                            ...
                                            if (DateTimeClass.IsCompareTime((DateTime)dtTimeInPM, tempSetTime, 0, Convert.ToDouble(Misc.MiscGraceInPM), out dOver))
                                            {
                                                //DateTime tempTime =
                                                //    dtTimeInPM.Value.AddMinutes(-Convert.ToDouble(Misc.MiscGraceInPM));
                                                DateTime tempTime = dtTimeInPM.Value;
                                                //if (DateTimeClass.IsCompareTime(tempTime, tempSetTime, 0))
                                                //{
                                                dtTimeInPM = (Misc.MiscGraceInPM <= tempTime.Minute)
                                                                 ? tempTime
                                    ...
                                    if (DateTime.TryParse(dtrTemp.TimeInOT, out tempTimeInOT))
                                    {
                                        ...
                                        if (Misc.MiscActive == true)
                                        {
                                            ...
                                            if (DateTimeClass.IsCompareTime((DateTime)dtTimeInOT, tempSetTime, 0, Convert.ToDouble(Misc.MiscGraceInOT), out dOver))
                                            {
                                                //DateTime tempTime =
                                                //    dtTimeInOT.Value.AddMinutes(-Convert.ToDouble(Misc.MiscGraceInOT));
                                                DateTime tempTime = dtTimeInOT.Value;
                                                //if (DateTimeClass.IsCompareTime(tempTime, tempSetTime, 0))
                                                //{
                                                dtTimeInOT = (Misc.MiscGraceInOT <= tempTime.Minute)
                                                                 ? tempTime
        ...
        public static bool IsActiveMisc()
        {
            ...
            using (var data = new DTRDbaseEntities())
            {
                Miscellaneou m = data.Miscellaneous.FirstOrDefault(mi => mi.MiscActive == true);
                bResult = (m != null);
            }
            return bResult;
        }
        ...
        public static Miscellaneou GetMiscellaneous()
        {
            using (var data = new DTRDbaseEntities())
            {
                Miscellaneou m = data.Miscellaneous.FirstOrDefault(mi => mi.MiscActive == true);
