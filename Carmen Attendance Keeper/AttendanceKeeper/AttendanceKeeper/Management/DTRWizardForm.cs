...
namespace AttendanceKeeper.Management
{
    public partial class DTRWizardForm : Form
    {
        ...
        List<JDTR> lDTRSource = new List<JDTR>();
        ...
        {
            labelDuration.Text = comboBoxMonth.Text + @" " + comboBoxStartDay.Text + @" - " + comboBoxEndDay.Text + @", " + comboBoxYear.Text;
            
            iMonth = Convert.ToInt32(comboBoxMonth.SelectedIndex + 1);
