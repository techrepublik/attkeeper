...
namespace AttendanceKeeper.Management
{
    public partial class PreferenceForm : Form
    {
        ...
        private void textBoxIPAddress_Validating(object sender, System.ComponentModel.CancelEventArgs e)
        {
            if (UtilityClass.IsValidIP(textBoxIPAddress.Text.Trim()))
            {
                config.AppSettings.Settings["IPAddressNW1"].Value = textBoxIPAddress.Text;
                config.Save(ConfigurationSaveMode.Modified);
                ConfigurationManager.RefreshSection("appSettings");
            }
            else
        ...
        {
            config.AppSettings.Settings["IPortNW1"].Value = textBoxPortNo.Text;
            config.Save(ConfigurationSaveMode.Modified);
            ConfigurationManager.RefreshSection("appSettings");
        }
        ...
        {
            config.AppSettings.Settings["ScreenTypeNW1"].Value = "BW";
            config.Save(ConfigurationSaveMode.Modified);
            ConfigurationManager.RefreshSection("appSettings");
        }
        ...
        {
            config.AppSettings.Settings["ScreenTypeNW1"].Value = "CO";
            config.Save(ConfigurationSaveMode.Modified);
            ConfigurationManager.RefreshSection("appSettings");
        }
        ...
        {
            config.AppSettings.Settings["MachineSN_NW1"].Value = textBoxSerialNo.Text;
            config.Save(ConfigurationSaveMode.Modified);
            ConfigurationManager.RefreshSection("appSettings");
        }
        ...
        {
            config.AppSettings.Settings["MacKeyTempNW1"].Value = textBoxKey.Text;
            config.Save(ConfigurationSaveMode.Modified);
            ConfigurationManager.RefreshSection("appSettings");
        }
        ...
        private void textBoxIP1_Validating(object sender, System.ComponentModel.CancelEventArgs e)
        {
            if (UtilityClass.IsValidIP(textBoxIP1.Text.Trim()))
            {
                config.AppSettings.Settings["IPAddress1"].Value = textBoxIP1.Text;
                config.Save(ConfigurationSaveMode.Modified);
                ConfigurationManager.RefreshSection("appSettings");
            }
            else
            {
                MessageBox.Show(@"Please check/verify the I.P. Address.", @"I.P. Address", MessageBoxButtons.OK,
                                MessageBoxIcon.Warning);
                textBoxIP1.Text = System.Configuration.ConfigurationManager.AppSettings["IPAddress1"];
            }
        }

        private void textBoxIP1_Leave(object sender, EventArgs e)
        {
            if (UtilityClass.IsValidIP(textBoxIP1.Text.Trim()))
            {
                config.AppSettings.Settings["IPAddress1"].Value = textBoxIP1.Text;
        ...
        private void textBoxPort1_Validating(object sender, System.ComponentModel.CancelEventArgs e)
        {
            config.AppSettings.Settings["IPort1"].Value = textBoxPort1.Text;
            config.Save(ConfigurationSaveMode.Modified);
            ConfigurationManager.RefreshSection("appSettings");
        }

        private void textBoxPort1_Leave(object sender, EventArgs e)
        {
            config.AppSettings.Settings["IPort1"].Value = textBoxPort1.Text;
            config.Save(ConfigurationSaveMode.Modified);
            ConfigurationManager.RefreshSection("appSettings");
        ...
        private void textBoxSerial1_Validated(object sender, EventArgs e)
        {
            config.AppSettings.Settings["MachineSN-SCC1"].Value = textBoxSerial1.Text;
            config.Save(ConfigurationSaveMode.Modified);
            ConfigurationManager.RefreshSection("appSettings");
        }

        private void textBoxSerial1_Leave(object sender, EventArgs e)
        {
            config.AppSettings.Settings["MachineSN-SCC1"].Value = textBoxSerial1.Text;
            config.Save(ConfigurationSaveMode.Modified);
            ConfigurationManager.RefreshSection("appSettings");
        ...
        private void textBoxSerial2_Validated(object sender, EventArgs e)
        {
            config.AppSettings.Settings["MachineSN-SCC2"].Value = textBoxSerial2.Text;
            config.Save(ConfigurationSaveMode.Modified);
            ConfigurationManager.RefreshSection("appSettings");
        }

        private void textBoxSerial2_Leave(object sender, EventArgs e)
        {
            config.AppSettings.Settings["MachineSN-SCC2"].Value = textBoxSerial2.Text;
            config.Save(ConfigurationSaveMode.Modified);
            ConfigurationManager.RefreshSection("appSettings");
        ...
        private void radioButtonBW1_CheckedChanged(object sender, EventArgs e)
        {
            config.AppSettings.Settings["ScreenType1"].Value = "BW";
            config.Save(ConfigurationSaveMode.Modified);
            ConfigurationManager.RefreshSection("appSettings");
        }
        ...
        {
            config.AppSettings.Settings["ScreenType1"].Value = "CO";
            config.Save(ConfigurationSaveMode.Modified);
            ConfigurationManager.RefreshSection("appSettings");
        }

        private void radioButtonBW2_CheckedChanged(object sender, EventArgs e)
        {
            config.AppSettings.Settings["ScreenType2"].Value = "BW";
            config.Save(ConfigurationSaveMode.Modified);
            ConfigurationManager.RefreshSection("appSettings");
        }
        ...
        {
            config.AppSettings.Settings["ScreenType2"].Value = "CO";
            config.Save(ConfigurationSaveMode.Modified);
            ConfigurationManager.RefreshSection("appSettings");
        }

        private void textBoxPort2_Validated(object sender, EventArgs e)
        {
            config.AppSettings.Settings["IPort2"].Value = textBoxPort2.Text;
            config.Save(ConfigurationSaveMode.Modified);
            ConfigurationManager.RefreshSection("appSettings");
        }

        private void textBoxIP2_Validated(object sender, EventArgs e)
        {
            if (UtilityClass.IsValidIP(textBoxIP2.Text.Trim()))
            {
                config.AppSettings.Settings["IPAddress2"].Value = textBoxIP2.Text;
                config.Save(ConfigurationSaveMode.Modified);
                ConfigurationManager.RefreshSection("appSettings");
            }
            else
            {
                MessageBox.Show(@"Please check/verify the I.P. Address.", @"I.P. Address", MessageBoxButtons.OK,
                                MessageBoxIcon.Warning);
                textBoxIP2.Text = System.Configuration.ConfigurationManager.AppSettings["IPAddress2"];
            }
        }

        private void textBoxIP2_Leave(object sender, EventArgs e)
        {
            if (UtilityClass.IsValidIP(textBoxIP2.Text.Trim()))
            {
                config.AppSettings.Settings["IPAddress2"].Value = textBoxIP2.Text;
        ...
        private void textBoxPort2_Leave(object sender, EventArgs e)
        {
            config.AppSettings.Settings["IPort2"].Value = textBoxPort2.Text;
            config.Save(ConfigurationSaveMode.Modified);
            ConfigurationManager.RefreshSection("appSettings");
        ...
        private void textBoxIP1_Validated(object sender, EventArgs e)
        {
