...
namespace AttendanceKeeper.Classes
{
    class DataManagementClass
    {
        ...
        public static List<JDTR> LoadDTRViaDTRBatch(Enrollee enrollee, int iMonth, int iStart, int iEnd, int iYear, List<DTR> lDTRs, Miscellaneous oMisc, string sName, string sDuration)
        {
